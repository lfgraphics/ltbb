...
const Navbar = () => {
	...
	return (
		<>
			...
			<div
				ref={ref}
				className='mycart fixed h-[10vh] z-40 right-0 top-0 transform transition-transform translate-x-full'
			>
				<aside className='flex flex-col w-64 h-screen px-5 py-8 overflow-y-auto bg-white border-r rtl:border-r-0 rtl:border-l dark:bg-gray-900 dark:border-gray-700'>
					<a href='#'>
						<MdCancel
							onClick={toggleCart}
							className='text-2xl hover:bg-black-900 hover:text-indigo-900'
						/>
					</a>
					<div className='flex flex-col justify-between flex-1 mt-6'>
						<nav className='flex-1 -mx-3 space-y-3 '>
							...
							>
								...
								<span className='mx-2 text-sm font-medium'>
									Managed Document Review Service
								</span>
							</Link>
						</nav>
						<div className='mt-6'>
							<div className='p-3 bg-gray-100 rounded-lg dark:bg-gray-800'>
								...
								<p className='mt-1 text-xs text-gray-500 dark:text-gray-400'>
									Discover TLB&apos;s new services! As your &apos;One Stop
									Shop&apos; for personal injury law firms, we offer complete
									medical and legal assistance. Our support spans all phases of
									litigation, from client intake to settlement. Experience our
									expertise and continuous support. Don&apos;t miss out!
								</p>
								<img
