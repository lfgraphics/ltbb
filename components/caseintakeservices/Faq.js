...
const faqData = [
	...
	},
	{
		...
		answer:
			'Our organisation specialises in handling all kinds of Civil, criminal and bankruptcy cases.',
	},
	{
		question:
			'What is the process for seeking assistance through your organisation?',
		answer:
	...
	},
	{
		...
		answer:
			'Eligibility is determined by our intake worker during the initial assessment. We will consider factors such as your income, location, and the specific nature of your case when determining your eligibility.',
	},
	{
		question: 'How long does the case intake process take?',
		answer:
			'The case intake process typically can take somewhere around a week to a month depending on your organisation’s unique needs.',
	},
	{
		question:
			'Can I speak with a case manager before starting the intake process?',
		answer:
			'Yes, you can contact our organisation and request to speak with a case manager before starting the intake process.',
	},
];
