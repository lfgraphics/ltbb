					...
					<div className="container max-w-xl p-6 py-12 mx-auto space-y-24 lg:px-8 lg:max-w-7xl">
						...
						<div className="grid lg:gap-8 lg:grid-cols-2 lg:items-center">
							...
							<div aria-hidden="true" className="mx-auto rounded-lg shadow-lg object-fill" data-aos="fade-left">
								<img src="/Paralegal Services/pexels-dominika-roseclay-3839649.jpg" alt="" className="mx-auto rounded-lg shadow-lg object-fill" />
							</div>
						</div>
						<div>
							<div className="grid lg:gap-8 lg:grid-cols-2 lg:items-center">
								...
								<div className="mx-auto rounded-lg shadow-lg object-filllg:col-start-1 lg:row-start-1" data-aos="fade-right">
									<img src="/Paralegal Services/pexels-karolina-grabowska-5387261.jpg" alt="" className="mx-auto rounded-lg shadow-lg object-fill" />
								</div>
							</div>
						</div>
					</div>
