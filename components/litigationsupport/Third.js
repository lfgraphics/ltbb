...
export default function Third() {
  ...
  let des1 = <p>Our expert document reviewers will evaluate your document set for relevance, privilege, and secrecy using our technological partnerships and our quality assurance methodology.

    <br></br>How do we help?
    <br></br>
    ●	Our dedicated litigation support team thoroughly reviews all your documents with set timelines.<br></br>
    ●	Based on the document review our litigation support team prepares feedback and makes sure that said changes are made within the timeline.<br></br>
    ●	We use advantace technologies to meet your needs.</p>
          ...
          <p className="dark:text-gray-400">
            ...
            <div>
              <table className="mx-auto d-block text-center">
                <thead><tr><th>PRE-JUDGMENT</th><th>POST-JUDGMENT </th></tr></thead>
                <tbody>
                  <tr className="text-left">
                    ...
                    <td className="text-left pl-6">
                      ...
                      <li>Judgment review and validation for placed accounts</li>
