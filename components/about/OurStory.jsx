    ...
    return (
        <section className='bg-[#F0F3FA] px-[9%] py-12 flex-col md:flex-row flex gap-8 lg:gap-20 min-h-[70vh]'>
            <div className="flex-[3] flex flex-col gap-4 text-[#181C31]">
                ...
                <p data-aos="fade-left" data-aos-delay="200">The Legal Base is the trading name of Omnifix Technology Solutions Private Limited. Incepted with a view to be a one-stop shop for law firms , corporate legal departments and single attorneys, TLB is led by seasoned legal professionals with a wealth of experience in working with clients from US , UK, Canada , Australia and New Zealand.</p>
